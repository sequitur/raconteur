...
const isMobileDevice = function() {
    /*
    What the hell is a mobile device? We define "mobile" as
    "narrower than 48ems", where an em is a root-element em.

    This will not work on old browsers (IE < 10), but
    elsewhere it provides the best reliability for keeping the
    js and the css media queries in sync.
    */
